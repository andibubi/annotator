...
import { sampleWithRequiredData } from '../annotation.test-samples';
...
describe('Annotation Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.annotations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to annotationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAnnotationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAnnotationIdentifier).toHaveBeenCalledWith(entity);
