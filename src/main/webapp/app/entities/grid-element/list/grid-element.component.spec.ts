...
import { sampleWithRequiredData } from '../grid-element.test-samples';
import { GridElementService } from '../service/grid-element.service';

import { GridElementComponent } from './grid-element.component';
import SpyInstance = jest.SpyInstance;

describe('GridElement Management Component', () => {
  let comp: GridElementComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(GridElementComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.gridElements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to gridElementService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getGridElementIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getGridElementIdentifier).toHaveBeenCalledWith(entity);
