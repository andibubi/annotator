package de.andreasbubolz.annotator.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.andreasbubolz.annotator.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.andreasbubolz.annotator.repository.UserRepository.USERS_BY_EMAIL_CACHE);
