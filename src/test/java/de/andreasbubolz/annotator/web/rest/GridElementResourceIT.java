...
class GridElementResourceIT {
    ...
    private static final String DEFAULT_RENDERER = "AAAAAAAAAA";
    private static final String UPDATED_RENDERER = "BBBBBBBBBB";
    ...
    void getAllGridElements() throws Exception {
        ...
        restGridElementMockMvc
            ...
            .andExpect(jsonPath("$.[*].renderer").value(hasItem(DEFAULT_RENDERER)))
    ...
    void getGridElement() throws Exception {
        ...
        restGridElementMockMvc
            ...
            .andExpect(jsonPath("$.renderer").value(DEFAULT_RENDERER))
    ...
    @Test
    @Transactional
    void getAllGridElementsByChannelIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedGridElement = gridElementRepository.saveAndFlush(gridElement);

        // Get all the gridElementList where channel equals to
        defaultGridElementFiltering("channel.equals=" + DEFAULT_CHANNEL, "channel.equals=" + UPDATED_CHANNEL);
    }

    @Test
    @Transactional
    void getAllGridElementsByChannelIsInShouldWork() throws Exception {
        // Initialize the database
        insertedGridElement = gridElementRepository.saveAndFlush(gridElement);

        // Get all the gridElementList where channel in
        defaultGridElementFiltering("channel.in=" + DEFAULT_CHANNEL + "," + UPDATED_CHANNEL, "channel.in=" + UPDATED_CHANNEL);
    }

    @Test
    @Transactional
    void getAllGridElementsByChannelIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedGridElement = gridElementRepository.saveAndFlush(gridElement);

        // Get all the gridElementList where channel is not null
        defaultGridElementFiltering("channel.specified=true", "channel.specified=false");
    }

    @Test
    @Transactional
    void getAllGridElementsByChannelContainsSomething() throws Exception {
        // Initialize the database
        insertedGridElement = gridElementRepository.saveAndFlush(gridElement);

        // Get all the gridElementList where channel contains
        defaultGridElementFiltering("channel.contains=" + DEFAULT_CHANNEL, "channel.contains=" + UPDATED_CHANNEL);
    }

    @Test
    @Transactional
    void getAllGridElementsByChannelNotContainsSomething() throws Exception {
        // Initialize the database
        insertedGridElement = gridElementRepository.saveAndFlush(gridElement);

        // Get all the gridElementList where channel does not contain
        defaultGridElementFiltering("channel.doesNotContain=" + UPDATED_CHANNEL, "channel.doesNotContain=" + DEFAULT_CHANNEL);
    }

    @Test
    @Transactional
    void getAllGridElementsByRendererIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedGridElement = gridElementRepository.saveAndFlush(gridElement);

        // Get all the gridElementList where renderer equals to
        defaultGridElementFiltering("renderer.equals=" + DEFAULT_RENDERER, "renderer.equals=" + UPDATED_RENDERER);
    }

    @Test
    @Transactional
    void getAllGridElementsByRendererIsInShouldWork() throws Exception {
        // Initialize the database
        insertedGridElement = gridElementRepository.saveAndFlush(gridElement);

        // Get all the gridElementList where renderer in
        defaultGridElementFiltering("renderer.in=" + DEFAULT_RENDERER + "," + UPDATED_RENDERER, "renderer.in=" + UPDATED_RENDERER);
    }

    @Test
    @Transactional
    void getAllGridElementsByRendererIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedGridElement = gridElementRepository.saveAndFlush(gridElement);

        // Get all the gridElementList where renderer is not null
        defaultGridElementFiltering("renderer.specified=true", "renderer.specified=false");
    }

    @Test
    @Transactional
    void getAllGridElementsByRendererContainsSomething() throws Exception {
        // Initialize the database
        insertedGridElement = gridElementRepository.saveAndFlush(gridElement);

        // Get all the gridElementList where renderer contains
        defaultGridElementFiltering("renderer.contains=" + DEFAULT_RENDERER, "renderer.contains=" + UPDATED_RENDERER);
    }

    @Test
    @Transactional
    void getAllGridElementsByRendererNotContainsSomething() throws Exception {
        // Initialize the database
        insertedGridElement = gridElementRepository.saveAndFlush(gridElement);

        // Get all the gridElementList where renderer does not contain
        defaultGridElementFiltering("renderer.doesNotContain=" + UPDATED_RENDERER, "renderer.doesNotContain=" + DEFAULT_RENDERER);
    }
    ...
    void getAllGridElementsByGridElementIsEqualToSomething() throws Exception {
        //GridElement gridElement; // Dies hatte JHipser erzueugt, gibt aber Fehler
    ...
    void partialUpdateGridElementWithPatch() throws Exception {
        ...
        partialUpdatedGridElement.x(UPDATED_X).y(UPDATED_Y).w(UPDATED_W).renderer(UPDATED_RENDERER).content(UPDATED_CONTENT);
